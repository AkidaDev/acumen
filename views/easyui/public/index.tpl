...
<div region="north" border="false" style="overflow: hidden; width: 100%; height:82px; background:#D9E5FD;">
    ...
    <div id="header-inner" style="float:right; overflow:hidden; height:80px; width:300px; line-height:25px; text-align:right; padding-right:20px;margin-top:-50px; ">
        Welcome！ {{.userinfo.Nickname}} <a href="javascript:void(0);" onclick="modifypassword()"> Cange Password</a>
    ...
    <div style="padding:20px 20px 40px 80px;" >
        <form id="form1" method="post">
            <table>
                <tr>
                    <td>old password</td>
                    <td><input type="password"  name="oldpassword" class="easyui-validatebox"  required="true" validType="password[5,20]" missingMessage="Enter Old Password"/></td>
                </tr>
                <tr>
                    <td>new password：</td>
                    <td><input type="password"  name="newpassword" class="easyui-validatebox" required="true" validType="password[5,20]" missingMessage="Enter New Password"  /></td>
                </tr>
                <tr>
                    <td>Repeat password：</td>
                    <td><input type="password"  name="repeatpassword"  class="easyui-validatebox" required="true" validType="password[5,20]" missingMessage="Repeat Password" /></td>
                </tr>
            </table>
        </form>
    </div>
...
<div id="toolbar">
    ...
    <a href="#" class="icon-redo" title="Close All"  onclick="redo()"></a>
</div>
<!--右键菜单-->
